@{
    ...
    FunctionsToExport = @(
        ...
        'Invoke-ExchangeCalendarManager','Invoke-CompanyPlaceManagement','Submit-SystemInfoTicket','Generate-SPUsageReport','Invoke-GroupMembershipCleanup','Start-RoleAwareToolset'
    )
}
